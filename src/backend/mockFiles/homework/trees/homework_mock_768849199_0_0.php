...
return [
    ...
    "comments" => [
        [
            "id" => 0,
            "senderId" => 0,// 0 id - это системные сообщения
            "senderName" => "System",// 0 id - это системные сообщения
        ...
        [
            "id" => 1,
            "senderId" => 2568108003, //userId в системе
            "senderName" => "Denis",// 0 id - это системные сообщения
        ...
        [
            "id" => 2,
            "senderId" => 768849199,
            "senderName" => "Ansar",// 0 id - это системные сообщения
