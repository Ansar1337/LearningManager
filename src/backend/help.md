...
- Доступные `actions`:
    ...
    - ### addHomeworkComment ###
        - **Описание**: Добавляет комментарий к домашнему заданию в модуле определенного курса.
        - **Параметры**:
            - `courseId`: INT // Идентификатор курса.
            - `moduleId`: INT // Идентификатор модуля.
            - `message`: STRING // Текст комментария.
        ...
        - **Структура ответа**:
          ...
          {
            "status": STRING, // "success" или "error"
            "data": STRING // Описание результата ("comment added" или описание ошибки)
          }
          ```
        - **Ошибки**:
            - **not logged in**: Пользователь не авторизован.
    ...
    - ### addHomeworkSubmissions ###
        ...
        - **Структура ответа**:
          ...
          {
            "status": STRING, // "success" или "error"
            "data": STRING // Хэш отправленного файла при успешной отправке или описание ошибки
          }
          ```
        - **Ошибки**:
            - **not logged in**: Пользователь не авторизован.
    ...
    - ### downloadHomeworkFile ### 
        - **Описание**: Позволяет скачать файл домашнего задания по уникальному хешу файла. Если запрос успешен, файл
